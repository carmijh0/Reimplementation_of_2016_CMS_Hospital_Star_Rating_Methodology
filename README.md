...
2.	Can I create an application to highlight these comparisons to help a potential patient make a more informed decision on choosing a provider for a procedure?
a.	I’m going to start with the 2015 inpatient data. If time allows, I’d like to add in 2011 – 2014 for a time series analysis.
b.	Further, I’d like to be able to add in outpatient facilities as well (another CMS dataset) if time allows. 
